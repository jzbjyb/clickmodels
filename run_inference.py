...
from clickmodels.novel_models import N_UbmModel
...
if __name__ == '__main__':
    ...
    if 'N-UBM' in USED_MODELS:
        ubmModel = N_UbmModel(ignoreIntents=True, ignoreLayout=True, config=config)
        ubmModel.train(sessions)
        print 'N-UBM', ubmModel.test(testSessions)
        del ubmModel